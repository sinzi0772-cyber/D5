  ...
  return <div className="app-shell">
    ...
    <main>
      <section className="content">
        ...
        <div className="panel">
          <div className="panel-head"><div><h2>고객 접수 현황</h2><span>최근 수정 고객은 상단과 고객명 옆에 표시됩니다</span></div></div>
